...
function program5(depth0,data) {
  ...
  return "\n                    <div class='sandbox_header'>\n                        <input class='submit' name='commit' type='button' value='Try it out!' />\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img alt='Throbber' class='response_throbber' src='http://petstore.swagger.io/images/throbber.gif' style='display:none' />\n                    </div>\n                    ";}
...
(function() {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.showWordnikDev = function(e) {
      return this.trigger('update-swagger-ui', {
        discoveryUrl: location.protocol+'//'+location.hostname+(location.port ? ':'+location.port: '') + "/api/swagger", //"http://api.wordnik.com/v4/resources.json",
        apiKey: ""
      });
    };
